...
7. On Critic approval (with improvements applied): _(--interactive only)_ If running with `--interactive`, use `AskUserQuestion` to present the plan with these options:
