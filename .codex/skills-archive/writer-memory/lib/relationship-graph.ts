...
export function removeRelationship(
  ...
  const index = memory.relationships.findIndex(
    (r) =>
      (r.from === char1Name && r.to === char2Name) ||
      (r.from === char2Name && r.to === char1Name),
  );
...
export function getRelationship(
  ...
  return memory.relationships.find(
    (r) =>
      (r.from === char1Name && r.to === char2Name) ||
      (r.from === char2Name && r.to === char1Name),
  );
...
export function listRelationships(characterName?: string): Relationship[] {
  ...
  return memory.relationships.filter(
    (r) => r.from === characterName || r.to === characterName,
  );
}
...
export function getRelationshipTimeline(
  ...
  return relationship.evolution.sort((a, b) =>
 ...
 */
export function getRelationshipArc(
  char1Name: string,
  char2Name: string,
): string {
 ...
 */
export function generateRelationshipProfile(
  char1Name: string,
  char2Name: string,
): string {
  const relationship = getRelationship(char1Name, char2Name);
