CREATE TABLE IF NOT EXISTS "public_check_sessions" (
...
CREATE TABLE IF NOT EXISTS "public_check_submissions" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
...
--> statement-breakpoint
CREATE TABLE IF NOT EXISTS "space_member_boards" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid() NOT NULL,
	"space_id" uuid NOT NULL,
...
END $$;
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "public_check_sessions_space_created_at_idx" ON "public_check_sessions" USING btree ("space_id","created_at");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "public_check_sessions_token_idx" ON "public_check_sessions" USING btree ("public_token");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "public_check_submissions_session_submitted_at_idx" ON "public_check_submissions" USING btree ("session_id","submitted_at");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "public_check_submissions_space_member_idx" ON "public_check_submissions" USING btree ("space_id","member_id");
--> statement-breakpoint
CREATE UNIQUE INDEX IF NOT EXISTS "space_member_boards_space_member_key" ON "space_member_boards" USING btree ("space_id","member_id");
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS "space_member_boards_space_updated_at_idx" ON "space_member_boards" USING btree ("space_id","updated_at");
