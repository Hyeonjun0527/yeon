...
const SIDEBAR_ITEMS = [
  { title: "수학 과제 누락 상담", status: "ready", meta: "김민수 · 4.8", active: true },
  { title: "교우 관계 고민 상담", status: "ready", meta: "이서윤 · 4.7", active: false },
  { title: "녹음 2026.04.08 10:30", status: "processing", meta: "", active: false },
];
  ...
  return (
    <div className={styles.appShell}>
      ...
      <div className={styles.sidebar}>
        ...
        <input className={styles.sidebarSearch} placeholder="학생, 제목 검색..." />
        ...
        <div className={styles.centerHeader}>
          <div>
            ...
            <p className={styles.centerMeta}>
              ...
              <span className={styles.editable}>대면 상담</span> · 2분 34초 · 원문 완료
            </p>
          </div>
          <div className={styles.centerActions}>
            <button className={styles.iconBtn}>🔊</button>
            <button className={styles.iconBtn}>📋</button>
            <button className={`${styles.iconBtn} ${styles.iconRed}`}>🗑</button>
          </div>
        </div>
      ...
      <div className={styles.aiPanel}>
        ...
        <div className={styles.aiSummary}>
          ...
          <div className={styles.aiSummaryText}>
            학원 일정(주 5회)으로 과제 시간 부족. 제출 기한을 익일 오전으로 조정하기로 합의.
            2주 후 학습 루틴 재점검 예정.
          </div>
        </div>
        ...
        <div className={styles.aiMessages} style={{ flex: 1 }}>
          ...
          <div className={`${styles.aiMsg} ${styles.aiMsgAssistant}`}>
            ...
            <br />
            <br />
            학원 일정이 빡빡해 과제 시간 확보가 어려운 상황이라, 제출 기한을 익일 오전으로
            조정했습니다. 2주간 적용 후 다시 점검하겠습니다.
            <br />
            <br />
            문의사항은 편하게 연락주세요.
          </div>
        ...
        <div className={styles.aiInputWrap}>
          <input className={styles.aiInput} placeholder="질문을 입력하세요..." />
        </div>
      </div>
    </div>
  );
