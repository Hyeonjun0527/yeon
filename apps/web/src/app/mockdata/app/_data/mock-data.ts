...
export const STUDENTS: Student[] = [
  {
    ...
    school: "연세중학교",
    memos: [
      { id: "m1", date: "2026.04.08", text: "과제 제출 기한 조정 합의. 2주 후 재점검." },
      { id: "m2", date: "2026.04.01", text: "월수금 수학, 화목 영어 학원 스케줄 확인." },
      { id: "m3", date: "2026.03.20", text: "수업 중 집중도 떨어짐. 앞자리로 배치 변경." },
    ],
    history: [
      { date: "2026.04.08", title: "수학 과제 누락 상담", type: "대면", summary: "학원 일정으로 과제 시간 부족, 제출 기한 조정 합의" },
      { date: "2026.04.05", title: "월간 학습 점검", type: "대면", summary: "수학 중간고사 대비 계획 수립, 주 3회 자습 권장" },
      { date: "2026.03.28", title: "보호자 통화", type: "전화", summary: "학원-집 학습 연계 방안 논의, 부모 협조 요청" },
      { date: "2026.03.20", title: "수업 태도 점검", type: "대면", summary: "집중력 저하 원인 파악, 자리 배치 변경" },
    ],
    aiReport:
  ...
  },
  {
    ...
    school: "한빛중학교",
    memos: [
      { id: "m4", date: "2026.04.07", text: "친구 갈등 상황 지속. 담임 선생님과 소통 필요." },
    ],
    history: [
      { date: "2026.04.07", title: "교우 관계 고민 상담", type: "대면", summary: "친구 갈등 중재, 담임과 협력 방안 논의" },
      { date: "2026.03.30", title: "학습 동기 부여", type: "대면", summary: "성적 정체에 따른 동기 저하, 단기 목표 설정" },
    ],
    aiReport:
  ...
  },
  {
    ...
    memos: [],
    history: [
      { date: "2026.04.06", title: "기초 학력 진단", type: "대면", summary: "수학 기초 연산 부족, 보충 학습 계획 수립" },
    ],
    aiReport:
  ...
  },
  {
    ...
    school: "하늘고등학교",
    memos: [
      { id: "m5", date: "2026.04.05", text: "이과/문과 고민 중. 적성 검사 결과 기다리는 중." },
      { id: "m6", date: "2026.03.15", text: "영어 성적은 양호. 수학 보충 필요 여부 검토." },
    ],
    history: [
      { date: "2026.04.05", title: "진로 상담", type: "대면", summary: "이과/문과 선택 고민, 적성 검사 권유" },
    ],
    aiReport:
  ...
  },
  {
    ...
    school: "연세중학교",
    memos: [
      { id: "m7", date: "2026.04.06", text: "게임 시간 하루 3시간 이상. 보호자와 규칙 합의." },
    ],
    history: [
      { date: "2026.04.06", title: "시간 관리 상담", type: "대면", summary: "게임 시간 과다, 학습 루틴 재설계" },
      { date: "2026.03.25", title: "보호자 면담", type: "대면", summary: "가정 학습 환경 점검, 스마트폰 사용 규칙 합의" },
    ],
    aiReport:
  ...
  },
  {
    ...
    school: "한빛중학교",
    memos: [
      { id: "m8", date: "2026.04.07", text: "영어 독해 전략 변경. 스키밍 → 정독 병행." },
      { id: "m9", date: "2026.04.01", text: "과학 보고서 구조 개선. 실험 목적-방법-결과 프레임." },
      { id: "m10", date: "2026.03.20", text: "단어 암기법: 어원 분석 + 문맥 활용법으로 전환." },
      { id: "m11", date: "2026.03.10", text: "학습 의지는 높으나 비효율적 반복 학습에 시간 낭비." },
    ],
    history: [
      { date: "2026.04.07", title: "영어 학습 전략 상담", type: "대면", summary: "영어 독해 전략 점검, 단어 암기법 변경" },
      { date: "2026.04.01", title: "과학 실험 보고서 피드백", type: "대면", summary: "보고서 구조 개선, 실험 결과 분석 방법 안내" },
    ],
    aiReport:
...
export const SIDEBAR_RECORDS: SidebarRecord[] = [
  { id: "rec1", title: "수학 과제 누락 상담", status: "ready", meta: "김민수 · 4.8", duration: "2분 34초", studentName: "김민수", type: "대면 상담" },
  { id: "rec2", title: "교우 관계 고민 상담", status: "ready", meta: "이서윤 · 4.7", duration: "5분 12초", studentName: "이서윤", type: "대면 상담" },
...
export const NOTIFICATIONS: Notification[] = [
  { id: "n1", title: "김민수 학생 전사가 완료되었습니다", time: "방금 전", unread: true },
  { id: "n2", title: "이서윤 학생 AI 요약이 생성되었습니다", time: "5분 전", unread: true },
  { id: "n3", title: "박도현 학생 보호자 면담 예정 (내일)", time: "1시간 전", unread: false },
  { id: "n4", title: "주간 상담 리포트가 준비되었습니다", time: "3시간 전", unread: false },
  { id: "n5", title: "정현우 학생 과제 미제출 3회 누적", time: "어제", unread: false },
];
...
export const DASHBOARD_RECENT = [
  { studentName: "김민수", title: "수학 과제 누락 상담", date: "오늘 03:46", color: "#60a5fa" },
  { studentName: "이서윤", title: "교우 관계 고민 상담", date: "어제 14:20", color: "#34d399" },
  { studentName: "정현우", title: "시간 관리 상담", date: "4.6 10:15", color: "#818cf8" },
  { studentName: "박도현", title: "기초 학력 진단", date: "4.6 09:00", color: "#fbbf24" },
  { studentName: "최지우", title: "진로 상담", date: "4.5 16:30", color: "#fb7185" },
];
...
export const DASHBOARD_ALERTS = [
  { studentName: "정현우", reason: "과제 미제출 3회 연속", gradient: "linear-gradient(135deg, #818cf8, #60a5fa)", initial: "현" },
  { studentName: "박도현", reason: "기초 학력 평가 재검 필요", gradient: "linear-gradient(135deg, #fbbf24, #fb923c)", initial: "도" },
];
