  ...
  return (
    <div className="flex-1 flex items-center justify-center min-h-0">
      <div className="flex flex-col items-center gap-4 text-center max-w-[360px]">
        ...
        <h2 className="m-0 text-[22px] font-bold tracking-[-0.02em]">녹음 중입니다</h2>
        <div className="flex items-center gap-[14px] px-5 py-[14px] mt-5 max-w-[400px] bg-red-dim border border-[rgba(248,113,113,0.2)] rounded">
          ...
          <span className="font-mono text-[11px] text-text-secondary">{fmtTime(elapsed)} 경과</span>
        </div>
        <div className="flex items-center gap-0.5 h-8">
          <span className={styles.vizBar1} style={{ width: 3, background: "var(--red)", borderRadius: 2 }} />
          <span className={styles.vizBar2} style={{ width: 3, background: "var(--red)", borderRadius: 2 }} />
          <span className={styles.vizBar3} style={{ width: 3, background: "var(--red)", borderRadius: 2 }} />
          <span className={styles.vizBar4} style={{ width: 3, background: "var(--red)", borderRadius: 2 }} />
          <span className={styles.vizBar5} style={{ width: 3, background: "var(--red)", borderRadius: 2 }} />
        </div>
        <button
