...
type HomeSpaceGateVariant = "home" | "student-management";

type HomeSpaceGateCopy = {
  badge: string;
...
const SPACE_GATE_COPY: Record<HomeSpaceGateVariant, HomeSpaceGateCopy> = {
  home: {
    badge: "상담 워크스페이스 시작",
