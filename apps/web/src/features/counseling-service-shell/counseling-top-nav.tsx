    ...
    pages: [
      {
        ...
        noteTitle: "추천 사용 흐름",
        note: "먼저 상담 기록을 만들고 전사와 요약을 검토한 뒤, 필요한 학생에 연결하세요. 이후 우측 AI 기능으로 원문 기반 질의를 이어가면 기록 검토가 빨라집니다.",
      },
    ],
  },
  "student-management": {
    ...
    pages: [
      ...
      },
      {
        ...
        note: "해당 학생에 상담 기록이 연결되어 있어야 합니다. 먼저 상담 기록에서 학생을 연결하거나 학생 상세의 상담 이력을 확인한 뒤 리포트를 내려받으세요.",
      },
      {
        id: "check-board",
        label: "출석·과제 보드",
